...
class AddressService {
    ...
    static checkAddressExist(contactId, addressId) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static get(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield contact_service_1.ContactService.checkContactExist(user.username, request.contact_id);
            const address = yield this.checkAddressExist(getRequest.contact_id, getRequest.id);
            return (0, address_model_1.toAddressResponse)(address);
        });
    }
    ...
    static list(user, contactId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield contact_service_1.ContactService.checkContactExist(user.username, contactId);
