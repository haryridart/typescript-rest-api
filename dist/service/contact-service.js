...
class ContactService {
    ...
    static get(user, id) {
        return __awaiter(this, void 0, void 0, function* () {
            const contact = yield this.checkContactExist(user.username, id);
            return (0, contact_model_1.toContactResponse)(contact);
        });
    }
    ...
    static search(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const total = yield database_1.prismaClient.contact.count({ where: { username: user.username, AND: filters } });
            return {
